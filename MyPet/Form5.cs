...
namespace MyPet
{
    ...
    {
        public string ServiceNameFromForm5 = "Cancelled";
        public Form5()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string filename = "C:/MyPet/Config/MyPetConfig.xml";
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("There is no service available to Delete.");
                    }
                }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Select a Service to Delete", "Infomation");
            }
            else
            {
                ServiceNameFromForm5 = listBox1.SelectedItem.ToString();
                this.Hide();
            }
        }
